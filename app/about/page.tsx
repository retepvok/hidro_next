    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <div className="col-lg-4 pg-10">
                    <p>Felkészültek vagyunk a javítandó berendezésekhez szükséges, nem beszerezhető alkatrészek legyártására a lehető legnagyobb fokú precizitással és minőségben. Fő célunk, hogy az
                        általunk
                        elvégzett javítás vagy felújítás a lehető leghosszabb élettartamot biztosítsa a felhasználó számára.</p>
                </div>
                <div className="col-lg-4 pg-10">
                    <p>Hisszük, hogy a mai „fogyasztói társadalomban” is van igény a hosszútávú megbízhatóságra a garancián túl is, márkától függetlenül. Ennek érdekében mindent meg is teszünk, legyen
                        az egy
